import { Palette, WorkbenchColors } from "@/types";

export type WorkbenchPartial = Partial<Record<keyof WorkbenchColors, string>>;

export function workBench(ctx: Palette): WorkbenchPartial {
    const { colors, tokenColors, widgetColors, palette } = ctx;
    ...
    return {
        ...
        "badge.background": palette.bright_blue,
        ...
        "editor.findMatchBackground": palette.bright_aqua + "40",
        "editor.findMatchHighlightBackground": palette.bright_purple + "40",
        "editor.findRangeHighlightBackground": palette.bright_purple + "40",
        ...
        "editorLightBulb.foreground": palette.purple_pink,
        ...
        "statusBar.background": palette.bright_red_pink,
