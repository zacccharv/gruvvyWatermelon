...
export function getUiColors(ctx: ThemeContext) {
	...
	return {
		...
		"editor.findMatchBackground": opacity(colors.mint, 0.15),
		"editor.findMatchHighlightBackground": opacity(colors.lavender, 0.15),
		"editor.findRangeHighlightBackground": opacity(colors.lavender, 0.15),
		"editor.foreground": colors.text,
		"editor.hoverHighlightBackground": opacity(colors.watermelon, 0.2),
		"editor.lineHighlightBackground": opacity(colors.surface1, 0.15),
		"editor.lineHighlightBorder": transparent,
		"editor.rangeHighlightBackground": opacity(colors.plum, 0.15),
		"editor.selectionBackground": opacity(colors.surface1, 0.4),
		...
		"editor.wordHighlightBackground": opacity(colors.surface1, 0.5),
		"editor.wordHighlightStrongBackground": opacity(colors.surface1, 0.5),
		...
		"symbolIcon.namespaceForeground": tokenColors.namespace,
		...
		"symbolIcon.operatorForeground": tokenColors.operator,
		"symbolIcon.packageForeground": colors.text,
